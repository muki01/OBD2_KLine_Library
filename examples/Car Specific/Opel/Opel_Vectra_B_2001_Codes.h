...
uint8_t ac_relay[8] = { 0x80, 0x11, 0xF1, 0x04, 0x30, 0x14, 0x07, 0xFF };
uint8_t mil_lamp_on[8] = { 0x80, 0x11, 0xF1, 0x04, 0x30, 0x11, 0x07, 0xFF };
uint8_t mil_lamp_off[8] = { 0x80, 0x11, 0xF1, 0x04, 0x30, 0x11, 0x07, 0x00 };
...
uint8_t tank_valve_20[8] = { 0x80, 0x11, 0xF1, 0x04, 0x30, 0x36, 0x07, 0x35 };
uint8_t tank_valve_100[8] = { 0x80, 0x11, 0xF1, 0x04, 0x30, 0x36, 0x07, 0xFF };
uint8_t cylinder1_injection_cut[8] = { 0x80, 0x11, 0xF1, 0x04, 0x30, 0x42, 0x07, 0x00 };
uint8_t cylinder2_injection_cut[8] = { 0x80, 0x11, 0xF1, 0x04, 0x30, 0x42, 0x07, 0x01 };
uint8_t cylinder3_injection_cut[8] = { 0x80, 0x11, 0xF1, 0x04, 0x30, 0x42, 0x07, 0x02 };
uint8_t cylinder4_injection_cut[8] = { 0x80, 0x11, 0xF1, 0x04, 0x30, 0x42, 0x07, 0x03 };
...
uint8_t imoReadLiveData[3] = { 0x02, 0x21, 0x01 };
uint8_t imoReadDTCs[5] = { 0x04, 0x18, 0x00, 0xFF, 0x00 };
uint8_t imoClearDTCs[4] = { 0x03, 0x14, 0xFF, 0x00 };
uint8_t imoProgramNewKey[4] = { 0x03, 0x30, 0x03, 0x08 };                  //0x3E
uint8_t imoProgramOldKey[4] = { 0x03, 0x30, 0x04, 0x08 };                  //0x3F
uint8_t imoEraseKeys[5] = { 0x04, 0x30, 0x05, 0x08, 0x00 };                //0x41
uint8_t imoEnterSecurityCode[6] = { 0x05, 0x30, 0x62, 0x07, 0x00, 0x00 };  //+Checsum; Last 2 Bytes = RAW Code (Input = 99 99, Byte Output = 99 99)
...
uint8_t imoReadLiveData_Response[21] = { 0x14, 0x61, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x02, 0x00, 0x00, 0x07, 0x00, 0x00, 0x00, 0x07, 0xA1, 0x00, 0x00 };
uint8_t imoReadDTCs_Response[3] = { 0x02, 0x58, 0x00 };          //0x5B
uint8_t imoClearDTCs_Response[4] = { 0x03, 0x7F, 0x14, 0x78 };   //Not Found
uint8_t imoClearDTCs_Response2[4] = { 0x03, 0x54, 0xFF, 0x00 };  //Correct Response

//KW82    4800 Baud  Checksum = CheckSum8 Modulo 256 or (Checksum 8 Xor)
uint8_t instumentClusterInit_Response[3] = { 0x55, 0x52, 0x80 };
uint8_t instumentClusterECUID_Response[34] = {  // All ECU ID = 24422203,0999,5198,0401,021,2
  0x20, 0xA0, 0x20,
  0x32, 0x34, 0x34, 0x32, 0x32, 0x32, 0x30, 0x33,  //Part Number (24422203)
  0x20,
  0x30, 0x39, 0x39, 0x39,  // (0999)
  0x20,
  0x35, 0x31, 0x39, 0x38,  // (5198)
  0x20,
  0x30, 0x34, 0x30, 0x31,  //Production Date (0401)
  0x20,
  0x30, 0x32, 0x31,  //Code Index (021)
  0x20,
  0x32,  //Code Version (2)
  0x06,  // Not Added to checksum calculation
  0x4F   // Checksum
};
